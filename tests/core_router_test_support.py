...
def inventory_snapshot(
    *,
    ...
    for resource_id in resource_ids:
        ...
        healthy = (
            "healthy" if is_external and external_ready else availability
        )
        ready = bool(
            availability == "available"
            and discovered
...
def validated_inventory(
    ...
    *,
    ...
    task: dict[str, Any],
    invocation_id: str = "core-test-inventory",
):
    del invocation_id
    from control_plane.core_types import seal_validated_inventory
    from control_plane.resource_registry import registry_contract_digest

    return seal_validated_inventory(
